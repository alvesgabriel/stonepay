defmodule Stonepay.AccountsTest do
  ...
  describe "register_user/1" do
    test "requires username, name, birthday, email and password to be set" do
    ...
    test "validates username, email and password when given" do
      {:error, changeset} =
        Accounts.register_user(%{email: "not valid", password: "invalid", username: "inv@lid"})

      assert %{
               username: ["only letters, numbers, underscores and dots are permitted"],
               name: ["can't be blank"],
               birthday: ["can't be blank"],
    ...
    test "validates maximum values for username, name, email and password for security" do
    ...
    test "validates age is greater than 18" do
      {:error, changeset} = Accounts.register_user(%{birthday: Date.utc_today()})

      assert "age is smaller than 18" in errors_on(changeset).birthday
    end
  ...
  describe "change_user_registration/2" do
    test "returns a changeset" do
      ...
      assert changeset.required == [:password, :email, :birthday, :name, :username]
    end
