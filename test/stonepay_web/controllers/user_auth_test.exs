defmodule StonepayWeb.UserAuthTest do
  use StonepayWeb.ConnCase, async: true

  alias Stonepay.Accounts
  alias StonepayWeb.UserAuth
  import Stonepay.AccountsFixtures

  @remember_me_cookie "_stonepay_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, StonepayWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      StonepayWeb.Endpoint.subscribe(live_socket_id)
